...
async function main() {
              ...
              create: [
                {
                  ...
                  description:
                    "Define claim-lock, lock-acquired, and release-lock events.",
                  position: 0,
                },
                {
              ...
              create: [
                {
                  ...
                  description:
                    "Set up schema, migrations, and singleton connection.",
                  position: 0,
                },
              ],
            },
  ...
  console.log(
    `Users created: ${user1.name} (${user1.id}), ${user2.name} (${user2.id})`,
  );
